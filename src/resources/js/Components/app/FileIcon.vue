<template>
    <span class="w-8 h-8 inline-flex items-center justify-center mr-2">
        <svg v-if="file.is_folder" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
...
<script setup>
import { isAudio, isExcel, isImage, isPdf, isText, isVideo, isWord, isZip } from '@/Helpers/file-helper';
